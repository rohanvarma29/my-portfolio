      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            And also I have been working as a Teaching Assistant from Jan 2024 for the "Network based application development" course.
            <br />
            <br />
          ...
          <ul>
            <li className="about-activity">
              <ImPointRight /> Sketching Portrait
            </li>
            <li className="about-activity">
